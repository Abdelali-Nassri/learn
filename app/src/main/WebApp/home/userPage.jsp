...
<div class="ui link centered cards" >
  ...
  <div class="ui card shadow-lg p-3 mb-5 bg-white rounded"  style=";width: 40%; background-repeat: no-repeat; background-position: center;background-image: url('<c:out value="${topic.topicImg }" />'); ">
  ...
  <div class="content " style="background-color: black;opacity: 0.7">
    ...
    <p style="color: white;" class="header float-right"><c:out value="${language == 'Fr' ? topic.topicNameFrancais : topic.topicNameArabe }" /> </p>
 <hr>
  <div class="d-flex justify-content-center">
  <form action="/learngettopicuser" method="get">
