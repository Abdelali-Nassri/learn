...
<div class="ui link centered cards" >
  ...
  <div class="content "style="background-color: black;opacity: 0.7">
    ...
    <p style="color: white;"class="header float-right"><c:out value="${language == 'Fr' ? field.fieldNameFrancais : field.fieldNameArabe }" /> </p>
  <hr>
  <div class="d-flex justify-content-center">
  <form action="/learngetFielduser" method="get">
