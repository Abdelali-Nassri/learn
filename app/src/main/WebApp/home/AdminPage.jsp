...
<div class="ui link centered cards" style="width: 74%;float: left;">
  ...
  <div class="ui card shadow-lg p-3 mb-5 bg-white rounded"  style=";width: 80%; background-repeat: no-repeat; background-position: center;background-image: url('<c:out value="${topic.topicImg }" />'); ">
 

  
  <div class="content " style="background-color: black;opacity: 0.7">
    <p style="color: white;" class="header float-left"><c:out value="${topic.topicName }" /></p>
    <p style="color: white;" class="header float-right"><c:out value="${language == 'Fr' ? topic.topicNameFrancais : topic.topicNameArabe }" /> 
 <hr>
  <div class="d-flex justify-content-center">
  <form action="/Admingettopic" method="get">
  <input type="hidden" name="topicName" value='<c:out value="${topic.topicName }"/>'>
  ...
  <form action="/Admindeletetopic" method="get">
  <input type="hidden" name="topicName" value='<c:out value="${topic.topicName }"/>'>
  <input type="hidden" name="topicImg" value='<c:out value="${topic.topicImg }"/>'>
  <div class="content d-flex align-items-end justify-content-between justify-content-center">
...
<form action="/AdminaddTopic" method="post" enctype="multipart/form-data" style="margin-right: 10%">
    ...
    <div class="field">
      <label>Topic Frensh Name</label>
      <input type="text" name="topicNameFrancais">
    </div>
 
  
    <div class="field">
      <label>Topic Arabic Name</label>
      <input type="text" dir="rtl" class="keyboardInput" name="topicNameArabe">
    </div>
    <div class="field">
